...
pub fn main() {
  ...
  // TODO: need independent registers, and history, and current_index
  // TODO: implement "thread loop"
  // TODO: snd --> send message to queue
  // TODO: rcv --> read from message queue (in order of sending), if no message, program wait
  ...
  // TODO handle deadlock: both rcv at same time --> terminates
  // TODO count how many times PID=1 call "snd"
